...
[![Build Status](https://dev.azure.com/cancellation/Oranges/_apis/build/status/mannysayah.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/cancellation/Oranges/_build/latest?definitionId=2&branchName=master)
